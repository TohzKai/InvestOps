...
export const businessModelCanvas = {
  keyPartners: [
    ...
    'Logistics partners (warehousing, shipping)',
    'Co-manufacturers',
  ],
  keyActivities: [
  ...
  keyResources: [
    ...
    'In-house expertise & industry knowledge',
    'Logistics infrastructure (warehouse, shipping)',
  ],
  valuePropositions: [
    'Reliable & efficient supply chain solutions for businesses',
    'One-stop solution for all import/export needs',
    'Flexible & customizable solutions',
  ],
  customerRelationships: [
    'Personalized consulting',
    'Account management',
    'Ongoing support & after-sales service',
  ],
  channels: [
    'Direct sales team',
  ...
  customerSegments: [
    'SMEs & startups (looking to expand globally)',
    'Retail businesses & distributors',
    'E-commerce entrepreneurs',
  ],
  costStructure: [
    'Logistics & shipping costs',
    'Warehousing & inventory costs',
    'Operating costs (staff, offices)',
  ],
  revenueStreams: [
    'Trading margins',
    'Service fees',
    'Subscription fees (for platform)',
  ],
};
